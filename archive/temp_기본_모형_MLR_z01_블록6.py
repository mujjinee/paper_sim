...
TRAIN_START = pd.Timestamp("2012-08-30")   # 학습 시작일
TRAIN_END = pd.Timestamp("2012-11-27")     # 학습 마지막일 (300일째)
TEST_START = pd.Timestamp("2012-11-28")    # 테스트 시작일
TEST_END = pd.Timestamp("2012-12-27")      # 테스트 마지막일 (100일째)
