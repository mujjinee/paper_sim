...
# method1_pc_max_ar_mlr_z03_block18.py
...
gc = os.path.join(OUT_DIR, "grid_method1_pc_max_ar_mlr_z03_block18.csv")
...
save_csv(os.path.join(OUT_DIR, "fig3_method1_z03.csv"),

         ["Label","nRMSE","Gap"],

         [[FIG_LABELS[i+1], round(f3n[i],2), round(f3g[i],2)] for i in range(10)])

save_csv(os.path.join(OUT_DIR, "fig5_method1_z03.csv"),
...
save_csv(os.path.join(OUT_DIR, "fig6_method1_z03.csv"),

         ["Label","nRMSE","Gap"],

         [[FIG_LABELS[i+1], round(f6n[i],2), round(f6g[i],2)] for i in range(10)])

save_csv(os.path.join(OUT_DIR, "fig8_method1_z03.csv"),
...
p3 = os.path.join(RESULTS_DIR, "fig3_method1_pc_max_ar_z03.png")
...
p5 = os.path.join(RESULTS_DIR, "fig5_method1_pc_max_ar_z03.png")
...
p6 = os.path.join(RESULTS_DIR, "fig6_method1_pc_max_mlr_z03.png")
...
p8 = os.path.join(RESULTS_DIR, "fig8_method1_pc_max_mlr_z03.png")
...
print("  완료 — 방법1 PC=max(DA,RT) AR+MLR 통합 (z03/블록18)")
