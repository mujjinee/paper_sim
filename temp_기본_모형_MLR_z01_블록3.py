...
TRAIN_START = pd.Timestamp("2012-06-01")   # 학습 시작일
TRAIN_END = pd.Timestamp("2012-08-29")     # 학습 마지막일 (300일째)
TEST_START = pd.Timestamp("2012-08-30")    # 테스트 시작일
TEST_END = pd.Timestamp("2012-09-28")      # 테스트 마지막일 (100일째)
