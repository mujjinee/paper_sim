...
# fig6_그리기.py
#
# 목적: 논문 Fig.6(fig3_그리기.py 와 같은 형식, MLR 제안모형의 W1/W2
#       비율별 nRMSE·optimality gap)을 논문값과 재현값을 나란히 놓고
#       그린다. 사용자가 직접 붙여넣은 표(MLR, 1/20, 1/10, ..., 1/0
#       총 11개 지점) 데이터를 그대로 쓴다.
#
...
# =====================================================================
# 1. 사용자가 붙여넣은 표 데이터를 그대로 입력 (MLR 제안모형, W1/W2 스윕)
# =====================================================================
labels = ["MLR", "1/20", "1/10", "1/5", "1/2", "1/1", "2/1", "5/1", "10/1", "20/1", "1/0"]  # x축 눈금 이름

ours_nrmse = [24.43, 24.07, 24.02, 23.86, 23.37, 23.04, 23.49, 29.77, 35.19, 40.41, 52.89]   # 재현 nRMSE(%)
ours_gap   = [11.34, 11.49, 11.43, 11.27, 11.05, 10.77, 10.44, 10.16, 10.04, 9.99, 10.18]      # 재현 gap(%)

paper_nrmse = [21.76, 21.92, 21.82, 21.72, 21.66, 21.72, 21.95, 22.40, 23.10, 24.20, 25.50]    # 논문 nRMSE(%)
paper_gap   = [12.59, 11.91, 11.68, 11.35, 10.65, 10.28, 9.95, 9.65, 9.45, 9.30, 9.28]           # 논문 gap(%)
...
figure.suptitle("Fig.6 재현 — MLR 제안모형 W1/W2 스윕 (벌금율 50%)", fontsize=14)  # 전체 제목
...
output_path = os.path.join(os.getcwd(), "results", "fig6_재현.png")  # 저장할 파일 경로
