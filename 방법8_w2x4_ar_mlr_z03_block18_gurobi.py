...
# 그리드 CSV
grid_csv = os.path.join(OUT_DIR, "grid_4term_ar_mlr_z03_block18.csv")
...
save_csv(os.path.join(OUT_DIR, "fig3_ar_z03_block18.csv"),
         ["Label", "nRMSE", "Gap"],
         [[FIG_LABELS[i], round(fig3_ar_n[i], 2), round(fig3_ar_g[i], 2)]
          for i in range(len(FIG_LABELS))])

save_csv(os.path.join(OUT_DIR, "fig5_ar_z03_block18.csv"),
...
save_csv(os.path.join(OUT_DIR, "fig6_mlr_z03_block18.csv"),
         ["Label", "nRMSE", "Gap"],
         [[FIG_LABELS[i], round(fig6_mlr_n[i], 2), round(fig6_mlr_g[i], 2)]
          for i in range(len(FIG_LABELS))])

save_csv(os.path.join(OUT_DIR, "fig8_mlr_z03_block18.csv"),
...
fig.tight_layout()
p3 = os.path.join(RESULTS_DIR, "방법2_fig3_ar_z03_block18.png")
...
p5 = os.path.join(RESULTS_DIR, "방법2_fig5_ar_z03_block18.png")
...
p6 = os.path.join(RESULTS_DIR, "방법2_fig6_mlr_z03_block18.png")
...
p8 = os.path.join(RESULTS_DIR, "방법2_fig8_mlr_z03_block18.png")
