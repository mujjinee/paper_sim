...
#
# 데이터: merged_for_simulation_z02.csv (Zone3)
...
BASE_DIR = os.getcwd()
MERGED_FILE = os.path.join(BASE_DIR, "merged_for_simulation_z02.csv")
...
TRAIN_END = pd.Timestamp("2013-02-25")
TEST_START = pd.Timestamp("2013-02-26")
TEST_END = pd.Timestamp("2013-03-27")
HISTORY_DATE = pd.Timestamp("2012-11-27")

CAPACITY_MW = 30.0
DURATION_HOURS = 1.0

OUT_DIR = os.path.join(BASE_DIR, "results", "fig_comparison_z02_block9")
