...
for i in range(n_train_obs):                                    # 3600개를 하나씩 순서대로
    ...
    surplus_cost[i] = (-W1 * train_rt_price[i]) + W2   # [수정] 정규화 제거
...
# =====================================================================
# 10. Table 4 스윕 - 0/1(기존 재현) + W1/W2 비율 10개 (4항 profit_change)
# =====================================================================
...
plt.title("Fig.6 4항(profit_change, 정규화X) - z03 블록18")
plt.tight_layout()
plt.savefig("fig6_mlr_profit_change.png", dpi=150)
print("저장 완료: fig6_mlr_profit_change.png")
plt.show()
...
plt.suptitle("Fig.8 4항(profit_change, 정규화X) - z03 블록18 (W1=W2=1)")
plt.tight_layout()
plt.savefig("fig8_mlr_profit_change.png", dpi=150)
print("저장 완료: fig8_mlr_profit_change.png")
plt.show()