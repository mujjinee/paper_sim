...
#
# 데이터: merged_for_simulation_z03.csv (Zone2), 블록9 구간
# =====================================================================
...
MERGED_FILE = os.path.join(BASE_DIR, "merged_for_simulation_z03.csv")  # 읽어올 병합 데이터 파일 경로 (Zone2)
...
BASELINE_NRMSE_Z03_BLOCK18 = 24.43          # 논문이 보고한 3변수(SSRD,TSR,Hour) 그대로 썼을 때 z02 결과 - 비교용
...
print()
print("=== 독자적 stepwise MLR (Zone3, 블록18/120일) 결과 ===")
...
print(f"{'논문 변수(ssrd,tsr,hour) 그대로, z03/블록18':<45}{BASELINE_NRMSE_Z03_BLOCK18:>9.2f}%")
