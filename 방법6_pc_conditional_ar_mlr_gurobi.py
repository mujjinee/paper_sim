...
fig.tight_layout()
p3 = os.path.join(RESULTS_DIR, "방법6_fig3_ar_z03_block18.png")
...
p5 = os.path.join(RESULTS_DIR, "방법6_fig5_ar_z03_block18.png")
...
p6 = os.path.join(RESULTS_DIR, "방법6_fig6_mlr_z03_block18.png")
...
p8 = os.path.join(RESULTS_DIR, "방법6_fig8_mlr_z03_block18.png")
