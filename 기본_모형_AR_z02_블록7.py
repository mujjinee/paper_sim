...
#
# 데이터: merged_for_simulation_z02.csv (Zone1, EST->UTC 보정,
...
TRAIN_START = pd.Timestamp("2012-09-29")   # 학습 시작일
TRAIN_END = pd.Timestamp("2012-12-27")     # 학습 마지막일 (300일째)
TEST_START = pd.Timestamp("2012-12-28")    # 테스트 시작일
TEST_END = pd.Timestamp("2013-01-26")      # 테스트 마지막일 (100일째)
HISTORY_DATE = pd.Timestamp("2012-09-28")  # 학습 첫날의 "직전 하루" (AR 입력 lag용, target 아님)
